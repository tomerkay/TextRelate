...
public class PipelineNoQuery {
    ...
    public static void pipelineNoQuery(String[] input) {
...
//        new CoreNLP();
    ...
    public static void PipelineNoQueryRSS(String[] input) {
        ...
        for (String link : links) {
            ...
            pipelineNoQuery(input_to_pipeline_function);
            i++;
            if (i >= feed_res_num) {
                break;
            }
    ...
    public static void main(String[] args) {
        ...
        if (input[16].equals("URL")){
            ...
            pipelineNoQuery(new_input_to_next_function);
        }
        else{
            ...
            PipelineNoQueryRSS(new_input_to_next_function);
        }
        if (input[11].equals("saveDB")) {
            dao.close();
        }
